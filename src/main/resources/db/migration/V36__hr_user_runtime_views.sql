ALTER TABLE attendance_schedule_templates
  ADD COLUMN IF NOT EXISTS schedule_mode varchar(20) NOT NULL DEFAULT 'strict' AFTER status,
  ADD COLUMN IF NOT EXISTS block_after_grace_period tinyint(1) NOT NULL DEFAULT '0' AFTER schedule_mode,
  ADD COLUMN IF NOT EXISTS enforce_location tinyint(1) NOT NULL DEFAULT '0' AFTER block_after_grace_period,
  ADD COLUMN IF NOT EXISTS location_id bigint DEFAULT NULL AFTER enforce_location;

ALTER TABLE attendance_schedule_template_days
  ADD COLUMN IF NOT EXISTS meal_minutes int NOT NULL DEFAULT '0' AFTER end_time,
  ADD COLUMN IF NOT EXISTS rest_minutes int NOT NULL DEFAULT '0' AFTER meal_minutes;

ALTER TABLE user_attendance_daily_records
  ADD COLUMN IF NOT EXISTS source_schedule_template_id bigint DEFAULT NULL AFTER minutes_late;

ALTER TABLE user_face_enrollments
  ADD COLUMN IF NOT EXISTS expires_at datetime DEFAULT NULL AFTER created_by;
