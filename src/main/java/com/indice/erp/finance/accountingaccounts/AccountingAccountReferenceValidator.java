...
@Component
class AccountingAccountReferenceValidator {

    private final JdbcTemplate jdbcTemplate;

    AccountingAccountReferenceValidator(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    void validateAssignment(FinanceContext context, AccountingAccountScopedAssignment assignment) {
