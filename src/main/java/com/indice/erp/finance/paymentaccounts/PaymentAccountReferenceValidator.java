...
@Component
class PaymentAccountReferenceValidator {

    private final JdbcTemplate jdbcTemplate;

    PaymentAccountReferenceValidator(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    void validateAssignment(FinanceContext context, PaymentAccountScopedAssignment assignment) {
