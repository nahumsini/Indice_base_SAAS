# Historia de la estructura de módulos básicos

Estado: archivo histórico de la guía fechada el 2026-03-26. Se conserva el texto original
como referencia; sus rutas, colores, conteos y declaración de producción no describen el estado
actual. Consulta la [guía vigente](../react/src/app/BasicModules/README.md) y el
[Frontend OS](indice-frontend-operating-system-v2.md) antes de implementar.
