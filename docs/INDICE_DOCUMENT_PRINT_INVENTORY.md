...
| 5 | Petty Cash | Statement / reconciliation document | Transaction Document | confidential, internal, multi-currency, approval-required | jsPDF + AutoTable; Letter portrait | P0 | Remastered | The fund business now leads the document instead of an Indice logo; physical signature/approval metadata is not available; all movements print without silent truncation |
