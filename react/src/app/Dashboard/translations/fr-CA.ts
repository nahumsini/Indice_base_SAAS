export const frCA = {
  ...
  kpis: {
    ...
    overdueExpenses: { title: 'Dépenses en retard', change: 'Attention immédiate' },
    budgetAvailable: { title: 'Budget disponible', change: 'Marge opérationnelle' },
    budgetUtilization: { title: 'Utilisation du budget', change: 'Budget consommé' },
