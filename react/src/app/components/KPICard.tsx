...
export function KPICard({ kpiId, title, value, change, isPositive }: KPICardProps) {
  ...
  return (
    <Card className="group min-h-[96px] w-full snap-center rounded-[8px] border border-slate-200/80 bg-white/90 p-3.5 shadow-[0_10px_30px_rgba(15,23,42,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:bg-white hover:shadow-[0_14px_36px_rgba(15,23,42,0.10)] dark:border-slate-700/70 dark:bg-slate-950/80 dark:shadow-[0_18px_42px_rgba(2,6,23,0.35)] dark:hover:border-slate-600 dark:hover:bg-slate-900">
      <div className="flex h-full items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-end justify-between gap-2">
            ...
            <div className={`inline-flex max-w-[48%] shrink-0 items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-semibold leading-5 ${trendClasses.badge}`}>
