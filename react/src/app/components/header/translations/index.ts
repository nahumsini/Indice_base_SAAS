...
const translations: Record<HeaderLocale, HeaderTranslations> = {
  ...
  'fr-CA': {
    ...
    actions: { notifications: 'Notifications', language: 'Langue et région', darkMode: 'Utiliser le mode sombre', lightMode: 'Utiliser le mode clair', learningMode: 'Parcours opérationnel', profile: 'Mon profil', settings: 'Paramètres', logout: 'Se déconnecter', loggingOut: 'Déconnexion…', company: 'Entreprise', switchCompany: "Changer d’entreprise", switchingCompany: 'Changement en cours…', companySwitchError: "Impossible de changer d’entreprise." },
  },
  'pt-BR': {
    greetings: { morning: 'Bom dia', afternoon: 'Boa tarde', evening: 'Boa noite' },
    actions: { notifications: 'Notificações', language: 'Idioma e região', darkMode: 'Usar modo escuro', lightMode: 'Usar modo claro', learningMode: 'Rota operacional', profile: 'Meu perfil', settings: 'Configurações', logout: 'Sair', loggingOut: 'Saindo…', company: 'Empresa', switchCompany: 'Trocar empresa', switchingCompany: 'Trocando empresa…', companySwitchError: 'Não foi possível trocar a empresa.' },
  },
  'ko-CA': {
    greetings: { morning: '좋은 아침입니다', afternoon: '좋은 오후입니다', evening: '좋은 저녁입니다' },
    actions: { notifications: '알림', language: '언어 및 지역', darkMode: '다크 모드 사용', lightMode: '라이트 모드 사용', learningMode: '운영 경로', profile: '내 프로필', settings: '설정', logout: '로그아웃', loggingOut: '로그아웃 중…', company: '회사', switchCompany: '회사 전환', switchingCompany: '회사 전환 중…', companySwitchError: '회사를 전환할 수 없습니다.' },
  },
  'zh-CA': {
    greetings: { morning: '早上好', afternoon: '下午好', evening: '晚上好' },
    actions: { notifications: '通知', language: '语言和地区', darkMode: '使用深色模式', lightMode: '使用浅色模式', learningMode: '运营路径', profile: '我的个人资料', settings: '设置', logout: '退出登录', loggingOut: '正在退出…', company: '公司', switchCompany: '切换公司', switchingCompany: '正在切换公司…', companySwitchError: '无法切换公司。' },
  },
};
