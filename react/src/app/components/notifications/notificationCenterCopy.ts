export const getNotificationCenterCopy = (locale: string) => {
  if (locale.toLowerCase().startsWith('es')) {
    return {
      ...
      subtitle: 'Prioriza alertas, tareas y comunicados que requieren atencion.',
      inbox: 'Bandeja',
      ...
      emptyDescription: 'Cuando algo requiera atencion aparecera aqui.',
      ...
      markRead: 'Leida',
      dismiss: 'Descartar',
      preferencesTitle: 'Preferencias por modulo',
      preferencesSubtitle: 'Elige que senales debe mostrar Indice en tu centro operativo.',
      preferencesNotice: 'Vista preparada para preferencias reales; la persistencia se conectara cuando exista el endpoint.',
      channelSystem: 'Sistema',
      frequencyImmediate: 'Inmediato',
      enabled: 'Activo',
      disabled: 'Silenciado',
      ...
      settingsSummary: 'Configuracion local de vista',
      settingsSummaryDescription: 'Estos controles preparan el contrato de preferencias por modulo.',
