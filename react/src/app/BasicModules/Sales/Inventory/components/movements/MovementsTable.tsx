            ...
            {movementGroups.map((group) => {
              ...
              return (
                <TableRow key={group.id} className="border-slate-100 hover:bg-[#FF6B5E]/5">
                  ...
                  <TableCell className="px-4 py-4 align-top">
                    <span className={`inline-flex rounded-md border px-2.5 py-1 text-[11px] font-black uppercase tracking-[0.08em] ${movementStatusTone[movement.status]}`}>
                      {t.operational.movementStatuses[movement.status]}
                    </span>
                  </TableCell>
                  ...
                  <TableCell className="px-4 py-4 align-top">
                    <MovementActions movement={movement} t={t} onEdit={onEdit} onPrint={onPrint} onTrack={onTrack} onCancel={onCancel} />
                  </TableCell>
                </TableRow>
              );
            })}
