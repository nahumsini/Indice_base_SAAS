        ...
        <label className="grid gap-2">
          ...
          <span className="relative">
            ...
            <Input
              ...
              className="h-11 rounded-lg border-slate-200 bg-white pl-10 text-sm font-semibold shadow-none focus:border-[#FF6B5E] focus:ring-[#FF6B5E]/20"
            />
          </span>
        </label>
            ...
            <div key={item.id} className={`grid gap-3 rounded-lg border p-3 md:grid-cols-[minmax(0,1fr)_140px_auto] ${hasAvailabilityIssue ? 'border-red-200 bg-red-50/60' : 'border-slate-200 bg-slate-50/70'}`}>
              <label className="grid gap-2">
                ...
                <Select value={item.productId} onValueChange={(productId) => updateLine(item.id, { productId })}>
                  <SelectTrigger className="h-11 rounded-lg border-slate-200 bg-white text-sm font-semibold shadow-none focus:border-[#FF6B5E] focus:ring-[#FF6B5E]/20">
              ...
              <label className="grid gap-2">
                ...
                <Input
                  ...
                  className="h-11 rounded-lg border-slate-200 bg-white text-sm font-semibold shadow-none focus:border-[#FF6B5E] focus:ring-[#FF6B5E]/20"
                />
              </label>
