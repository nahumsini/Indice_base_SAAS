    ...
    >
          <section className="grid gap-3 md:grid-cols-2">
            ...
            >
              ...
              <span className="mt-3 block text-sm font-semibold text-slate-950">{copy.fromPhone}</span>
            ...
            >
              ...
              <span className="mt-3 block text-sm font-semibold text-slate-950">{copy.fileTitle}</span>
              <span className="mt-1 block text-sm leading-6 text-slate-600">
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <h3 className="text-sm font-semibold text-slate-700">{copy.previewTitle}</h3>
