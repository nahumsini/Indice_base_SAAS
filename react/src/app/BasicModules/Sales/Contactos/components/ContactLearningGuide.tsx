...
const guideIcons = [UsersRound, MessageCircle, ReceiptText] as const;

export function ContactLearningGuide({ copy }: ContactLearningGuideProps) {
  const [isCollapsed, setIsCollapsed] = useLocalStorageState<boolean>(
    'indice.sales.contacts.learningGuide.collapsed',
    false,
  );
