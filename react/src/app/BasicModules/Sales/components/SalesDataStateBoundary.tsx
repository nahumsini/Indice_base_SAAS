...
const copyByLocale: Record<string, DataStateCopy> = {
  'es-MX': {
    ...
    loadErrorTitle: 'No pudimos cargar Ventas',
    ...
    partialDescription: 'Una parte de Ventas no respondió. Puedes continuar consultando los datos disponibles o reintentar.',
  ...
  'es-CO': {
    ...
    loadErrorTitle: 'No pudimos cargar Ventas', loadErrorDescription: 'La información no está disponible todavía. Vuelve a intentarlo para consultar el estado real.',
    partialTitle: 'Hay información parcial', partialDescription: 'Una parte de Ventas no respondió. Puedes continuar con los datos disponibles o volver a intentarlo.',
  ...
  'fr-CA': {
    ...
    loadErrorTitle: 'Impossible de charger Ventes', loadErrorDescription: 'Les données ne sont pas encore disponibles. Réessayez pour obtenir l’état confirmé.',
    partialTitle: 'Certaines données sont indisponibles', partialDescription: 'Une partie de Ventes ne répond pas. Vous pouvez utiliser les données disponibles ou réessayer.',
  ...
  'pt-BR': {
    ...
    loadErrorTitle: 'Não foi possível carregar Vendas', loadErrorDescription: 'As informações ainda não estão disponíveis. Tente novamente para obter o estado confirmado.',
    partialTitle: 'Há informações indisponíveis', partialDescription: 'Parte de Vendas não respondeu. Você pode usar os dados disponíveis ou tentar novamente.',
  ...
  'ko-CA': {
    ...
    loadErrorTitle: '영업 모듈을 불러올 수 없습니다', loadErrorDescription: '정보를 아직 사용할 수 없습니다. 확인된 상태를 불러오려면 다시 시도하세요.',
    partialTitle: '일부 정보를 사용할 수 없습니다', partialDescription: '영업 모듈의 일부가 응답하지 않았습니다. 사용 가능한 데이터를 보거나 다시 시도할 수 있습니다.',
  ...
  'zh-CA': {
    ...
    loadErrorTitle: '无法加载销售模块', loadErrorDescription: '数据暂不可用。请重试以获取服务器确认的状态。',
    partialTitle: '部分数据不可用', partialDescription: '销售模块的部分服务未响应。您可以继续查看现有数据或重试。',
