    ...
    return (
      <section className="flex min-h-full items-center justify-center bg-white p-8">
        <div className="max-w-sm rounded-lg border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
          <h3 className="text-lg font-black text-slate-950">{t.publicCatalog.emptyManagerTitle}</h3>
    ...
    <section className="min-h-0 overflow-y-auto bg-white">
      <div className="space-y-5 p-5">
        <section className="rounded-lg border border-slate-200 bg-white p-4">
          <h3 className="text-lg font-black text-slate-950">{t.publicCatalog.identity}</h3>
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            <label className="grid gap-1.5">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.catalogTitle}</span>
              <Input value={catalog.title} onChange={(event) => onChange({ title: event.target.value })} placeholder={t.publicCatalog.catalogTitle} />
            </label>
            <label className="grid gap-1.5">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.coverImagePlaceholder}</span>
            ...
            <label className="grid gap-1.5">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.ctaLabelField}</span>
            ...
            <label className="grid gap-1.5">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.contactMethod}</span>
            ...
            <label className="grid gap-1.5">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.contactValuePlaceholder}</span>
            ...
            <label className="grid gap-1.5 md:col-span-2">
              <span className="text-xs font-black text-slate-500">{t.publicCatalog.catalogDescription}</span>
