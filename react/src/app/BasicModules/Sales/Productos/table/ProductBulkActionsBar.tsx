...
export function ProductBulkActionsBar({
  ...
  return (
    <section className="rounded-2xl border border-[#F4C84A]/30 bg-[#F4C84A]/10 px-4 py-3 shadow-sm">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            type="button"
            variant="outline"
            className="h-9 rounded-xl border-emerald-200 bg-emerald-50 px-3 text-sm font-semibold text-emerald-700 shadow-none hover:bg-emerald-100"
            onClick={onSetActive}
          >
          ...
          <Button
            type="button"
            variant="outline"
            className="h-9 rounded-xl border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 shadow-none hover:bg-slate-100"
          ...
          <Button
            type="button"
            variant="outline"
            className="h-9 rounded-xl border-[#FF6B5E]/25 bg-white px-3 text-sm font-semibold text-[#B63B32] shadow-none hover:bg-[#FF6B5E]/10"
          ...
          <Button
            type="button"
            variant="outline"
            className="h-9 rounded-xl border-slate-200 bg-white px-3 text-sm font-semibold text-slate-600 shadow-none hover:bg-slate-100"
