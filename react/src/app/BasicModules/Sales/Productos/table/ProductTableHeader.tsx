...
function ProductSortableHeader({
  ...
  return (
    <button
      type="button"
      className="inline-flex items-center gap-2 text-left text-xs font-bold uppercase tracking-[0.14em] text-slate-500 transition-colors hover:text-slate-950 dark:text-slate-300 dark:hover:text-white"
...
export function ProductTableHeader({
  ...
  return (
    <TableRow className="border-slate-200 bg-slate-50 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-900">
      ...
      <TableHead className="w-[88px] px-5 py-4 text-xs font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-300">
      ...
      <TableHead className="w-[250px] px-5 py-4 text-right text-xs font-bold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-300">
