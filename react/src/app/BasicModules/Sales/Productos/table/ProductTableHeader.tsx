...
export function ProductTableHeader({
  ...
  return (
    <TableRow className="border-slate-200 bg-slate-50 hover:bg-slate-50">
      ...
      <TableHead className="w-[88px] px-5 py-4 text-xs font-bold uppercase tracking-[0.14em] text-slate-500">
      ...
      <TableHead className="w-[250px] px-5 py-4 text-right text-xs font-bold uppercase tracking-[0.14em] text-slate-500">
