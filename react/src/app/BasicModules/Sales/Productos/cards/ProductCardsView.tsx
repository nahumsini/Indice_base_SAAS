    ...
    <>
      <section className="rounded-lg border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-100 p-5">
          <h3 className="text-xl font-black text-slate-950">{t.sections.cardsTitle}</h3>
          <p className="mt-2 text-sm leading-6 text-slate-500">{t.sections.cardsDescription}</p>
        </div>

        {products.length === 0 ? (
          <div className="px-5 py-12 text-center text-sm font-semibold text-slate-500">{t.table.empty}</div>
        ) : (
                  ...
                  <div className="space-y-4 p-5">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <div className="rounded-lg border border-slate-100 bg-slate-50 p-3">
                        ...
                        <p className="mt-1 font-black text-[#177d66]">{formatProductCurrency(getProductProfit(product))}</p>
                      ...
                      <div className="rounded-lg border border-slate-100 bg-slate-50 p-3">
                        ...
                        <p className="mt-1 truncate font-black text-slate-950">{getCategoryLabel(product.category, t)}</p>
                      </div>
                    </div>
