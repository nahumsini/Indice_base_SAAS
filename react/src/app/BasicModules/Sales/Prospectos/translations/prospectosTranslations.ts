...
export const enCA = {
  ...
  flow: {
    ...
    description: 'Configure the stages used by this company in Kanban, stage filters, and opportunity controls.',
    eyebrow: 'Company configuration',
    catalogTitle: 'Available flows',
    catalogDescription: 'Select the flow used by this workspace, or open one to review and configure its stages.',
    selectFlow: 'Active flow',
    flowName: 'Flow name',
    newFlow: 'New flow',
    newFlowName: 'New opportunity flow',
    create: 'Create flow',
    factory: 'Factory',
    activeBadge: 'In use',
    defaultBadge: 'Company default',
    flowCardSummary: (stages: number, opportunities: number) => `${stages} stages · ${opportunities} opportunities`,
    editFlow: 'Edit',
    viewStages: 'View stages',
    useFlow: 'Use flow',
    activating: 'Switching...',
    factoryReadOnly: 'The factory flow is always available and cannot be edited. Create a company flow to customize its stages.',
    createTitle: 'Create opportunity flow',
    editTitle: (name: string) => `Configure ${name}`,
    editorDescription: 'Organize the open stages. Won and Lost remain protected in every flow.',
    backToFlows: 'Back to flows',
    stageListTitle: 'Flow stages',
    stageUsage: 'Usage',
    stageActions: 'Actions',
    managerSummary: (count: number, name: string) => `${count} ${count === 1 ? 'flow' : 'flows'} · Active: ${name}`,
    editorSummary: (total: number, open: number) => `${open} open · ${total} total stages`,
    notAvailable: 'Not available',
    addStage: 'Add stage',
    restoreDefault: 'Restore default flow',
    stageName: 'Stage name',
    probability: 'Default probability',
    color: 'Colour',
    opportunities: (count: number) => `${count} ${count === 1 ? 'opportunity' : 'opportunities'}`,
    protectedStage: 'Protected stage',
    inUse: 'Move its opportunities before removing it.',
    ...
    save: 'Save flow',
    saving: 'Saving flow...',
    loadError: 'The company flow could not be loaded. The standard flow is shown temporarily.',
    retry: 'Retry',
    saveError: 'The flow could not be saved.',
    maxStages: 'The flow supports up to 12 stages.',
    adminOnly: 'Your account does not have permission to manage opportunity flows.',
    colors: {
      BLUE: 'Blue', AQUA: 'Aqua', GREEN: 'Green', YELLOW: 'Yellow',
      CORAL: 'Coral', VIOLET: 'Violet', SLATE: 'Slate',
    },
  },
  kpis: {
...
export const esMX: ProspectosCopy = {
  ...
  flow: {
    ...
    description: 'Configura las etapas que usa esta empresa en Kanban, filtros y controles de oportunidades.',
    eyebrow: 'Configuración de empresa',
    catalogTitle: 'Flujos disponibles',
    catalogDescription: 'Selecciona el flujo que usa esta vista o abre uno para revisar y configurar sus etapas.',
    selectFlow: 'Flujo activo',
    flowName: 'Nombre del flujo',
    newFlow: 'Nuevo flujo',
    newFlowName: 'Nuevo flujo de oportunidades',
    create: 'Crear flujo',
    factory: 'De fábrica',
    activeBadge: 'En uso',
    defaultBadge: 'Predeterminado de la empresa',
    flowCardSummary: (stages, opportunities) => `${stages} etapas · ${opportunities} oportunidades`,
    editFlow: 'Editar',
    viewStages: 'Ver etapas',
    useFlow: 'Usar flujo',
    activating: 'Cambiando...',
    factoryReadOnly: 'El flujo de fábrica siempre está disponible y no se puede editar. Crea un flujo de empresa para personalizar sus etapas.',
    createTitle: 'Crear flujo de oportunidades',
    editTitle: (name) => `Configurar ${name}`,
    editorDescription: 'Organiza las etapas abiertas. Ganada y Perdida permanecen protegidas en todos los flujos.',
    backToFlows: 'Volver a flujos',
    stageListTitle: 'Etapas del flujo',
    stageUsage: 'Uso',
    stageActions: 'Acciones',
    managerSummary: (count, name) => `${count} ${count === 1 ? 'flujo' : 'flujos'} · Activo: ${name}`,
    editorSummary: (total, open) => `${open} abiertas · ${total} etapas totales`,
    notAvailable: 'No disponible',
    addStage: 'Agregar etapa',
    restoreDefault: 'Restaurar flujo predeterminado',
    stageName: 'Nombre de la etapa',
    probability: 'Probabilidad predeterminada',
    color: 'Color',
    opportunities: (count) => `${count} ${count === 1 ? 'oportunidad' : 'oportunidades'}`,
    protectedStage: 'Etapa protegida',
    inUse: 'Mueve sus oportunidades antes de eliminarla.',
    moveUp: 'Subir etapa',
    ...
    cancel: 'Cancelar',
    save: 'Guardar flujo',
    saving: 'Guardando flujo...',
    loadError: 'No se pudo cargar el flujo de la empresa. Se muestra temporalmente el flujo estándar.',
    retry: 'Reintentar',
    saveError: 'No se pudo guardar el flujo.',
    maxStages: 'El flujo admite hasta 12 etapas.',
    adminOnly: 'Tu cuenta no tiene permiso para administrar flujos de oportunidades.',
    colors: {
      BLUE: 'Azul', AQUA: 'Aqua', GREEN: 'Verde', YELLOW: 'Amarillo',
      CORAL: 'Coral', VIOLET: 'Violeta', SLATE: 'Gris',
    },
  },
  kpis: {
