...
export function ProspectosAgenda({
  ...
  return (
    <section className="space-y-5">
      <div className="rounded-[24px] border border-[#FF6B5E]/20 bg-[#FF6B5E]/[0.07] p-5 shadow-sm">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Input
              ...
              className="h-10 w-[168px] rounded-xl border-slate-200 bg-white font-bold shadow-none"
            />
            <Button variant="outline" className="h-10 rounded-xl border-slate-200 bg-white px-3 font-bold" onClick={() => agenda.moveAgendaWindow(-1)}>
              <ArrowUp className="h-4 w-4 -rotate-90" />
            </Button>
            <Button variant="outline" className="h-10 rounded-xl border-slate-200 bg-white px-4 font-bold" onClick={agenda.goToToday}>
              {copy.agenda.today}
            </Button>
            <Button variant="outline" className="h-10 rounded-xl border-slate-200 bg-white px-3 font-bold" onClick={() => agenda.moveAgendaWindow(1)}>
              <ArrowUp className="h-4 w-4 rotate-90" />
