...
export const salesFieldClassName = 'h-11 rounded-lg border-slate-200 bg-white text-slate-950 shadow-none focus:border-[#FF6B5E] focus:ring-[#FF6B5E]/20 dark:border-slate-700 dark:bg-slate-950 dark:text-white';
...
export function SectionTitle({ title }: { title: string }) {
  return <h3 className="text-sm font-medium text-slate-500 dark:text-slate-400">{title}</h3>;
}
