...
export const salesFieldClassName = 'h-11 rounded-lg border-slate-200 bg-white text-slate-950 shadow-none focus:border-[#FF6B5E] focus:ring-[#FF6B5E]/20';
...
export function SectionTitle({ title }: { title: string }) {
  return <h3 className="text-sm font-black uppercase tracking-[0.16em] text-slate-500">{title}</h3>;
}
...
export function SectionCard({
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 dark:border-slate-700 dark:bg-slate-900/40">
      <div className="mb-4">
