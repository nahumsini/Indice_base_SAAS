export const enCA = {
  ...
  modal: {
    ...
    lineItems: {
      ...
      empty: 'No items yet. Add a product or keep the sale without items if it is only a quick customer record.',
      quantity: 'Quantity',
      unitPrice: 'Unit price',
      discount: 'Discount %',
      tax: 'Tax %',
    ...
    workspace: {
      ...
      noItems: 'This direct sale has no line items. You can register them later if needed.',
    ...
    wizard: {
      ...
      originDescription: 'Select the customer. Opportunity and approved quote are optional and will complete each other when they are linked.',
      noApprovedQuotesTitle: 'No approved quotes are available',
      noApprovedQuotesDescription: 'Approve a quote before creating the sale. Draft or rejected quotes cannot be converted.',
      goToQuotes: 'Go to quotes',
      approvedQuoteSelected: 'Approved quote selected',
      inheritedFieldsHelper: 'Customer, seller, currency, and totals are inherited from the approved quote to preserve the authorized commercial agreement.',
      ...
      originError: 'Select or add a customer before continuing.',
      operationError: 'Select an active warehouse linked to a business unit and business, plus a valid sale date.',
      ...
      footerEmpty: 'Select or add a customer to start',
