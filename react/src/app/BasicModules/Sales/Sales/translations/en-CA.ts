export const enCA = {
  ...
  modal: {
    ...
    wizard: {
      ...
      originDescription: 'Choose the commercial opportunity and the approved quote that authorizes this sale.',
      ...
      operationDescription: 'Confirm the unit, business, sale date, and warehouse context that will receive the handoff.',
      ...
      readyDescription: 'The approved quote and operational context are complete. Review the line items and total before saving.',
      pendingTitle: 'Information is still missing',
      pendingDescription: 'Return to the previous steps and complete the approved quote or operational context.',
      back: 'Back',
      continue: 'Continue',
      create: 'Create sale',
      preview: 'Preview sale',
      originError: 'Select an approved quote before continuing.',
      operationError: 'Select a valid business unit and business, and confirm the sale date before continuing.',
      saveError: 'The sale could not be created. Review the information and try again.',
      footerEmpty: 'Select an approved quote to start',
