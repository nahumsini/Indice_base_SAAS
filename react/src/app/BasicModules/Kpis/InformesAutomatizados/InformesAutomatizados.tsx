...
export default function InformesAutomatizados() {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex min-w-0 gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-4xl text-sm leading-6 text-slate-700 dark:text-slate-200">
              Define reglas para enviar KPIs, estados financieros y paquetes ejecutivos por canal.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-lg border border-blue-200 bg-blue-50 p-5 shadow-sm dark:border-blue-900 dark:bg-blue-950/20">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-blue-200 bg-white text-blue-700 dark:border-blue-900 dark:bg-slate-950 dark:text-blue-200">
              <BellRing className="h-5 w-5" />
            </span>
            <div>
          ...
          <Button
            type="button"
            variant="outline"
            className="h-9 w-fit rounded-lg border-blue-300 bg-white text-sm font-semibold text-blue-800 hover:bg-blue-100 dark:border-blue-800 dark:bg-slate-950 dark:text-blue-200 dark:hover:bg-blue-950/40"
          >
          ...
          <div className="grid gap-3 p-5 md:grid-cols-4">
            {[
              ...
              <div key={title} className="rounded-lg border border-slate-200 p-4 dark:border-slate-800">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-sm font-bold text-blue-800 dark:bg-blue-950/50 dark:text-blue-200">
                  {index + 1}
                </span>
