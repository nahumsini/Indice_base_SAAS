...
const es: DiagnosisCopy = {
  ...
  eyebrow: 'Autoevaluador ejecutivo · diagnosis/1.0',
...
const en: DiagnosisCopy = {
  ...
  eyebrow: 'Executive self-assessment · diagnosis/1.0',
...
const fr: DiagnosisCopy = {
  ...
  eyebrow: 'Autoévaluation exécutive · diagnosis/1.0',
...
const pt: DiagnosisCopy = {
  ...
  eyebrow: 'Autoavaliação executiva · diagnosis/1.0',
...
const ko: DiagnosisCopy = {
  ...en,
  title: '기업 매트릭스', subtitle: '시스템 근거로 구성된 의사결정 모델: IME, SWOT, BCG 및 전문 운영 매트릭스.', eyebrow: '경영진 자체 평가 · diagnosis/1.0',
...
const zh: DiagnosisCopy = {
  ...en,
  title: '企业矩阵', subtitle: '基于系统证据构建的决策模型：IME、SWOT、BCG 与专业运营矩阵。', eyebrow: '管理层自评 · diagnosis/1.0',
