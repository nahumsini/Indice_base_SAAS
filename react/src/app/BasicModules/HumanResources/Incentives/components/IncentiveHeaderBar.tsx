...
export function IncentiveHeaderBar({ onColumns, onCreate }: IncentiveHeaderBarProps) {
  return (
    <div className="mb-5 rounded-lg border border-[#143675]/20 bg-[#143675]/10 p-6 shadow-sm dark:border-[#4a7bc8]/30 dark:bg-[#143675]/15">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-slate-600 dark:text-slate-300">
            Manage manual bonuses, automated rules, and payroll application timing.
          </p>
        </div>
