...
export const koCA = {
  ...
  columns: { folio: '접수번호', employee: '직원', type: '유형', payrollTreatment: '급여', startDate: '시작일', endDate: '종료일', days: '일수', status: '상태', actions: '작업' },
  pagination: {
    pageSize: '페이지당 행',
  ...
  filters: { title: '필터', searchLabel: '요청 검색', searchPlaceholder: '직원 또는 접수번호', status: '상태', allStatuses: '모든 상태', type: '유형', allTypes: '모든 유형', payrollTreatment: '급여 처리', allPayrollTreatments: '모든 처리', employee: '직원', allEmployees: '전체 직원' },
  kpis: {
    total: '총 요청',
    pending: '대기',
    approved: '승인',
  ...
  payrollTreatment: { paid: '유급', unpaid: '무급' },
  ...
  modal: { ...enCA.modal, title: '권한 요청', subtitle: '새 요청을 제출하려면 양식을 작성하세요.', permissionType: '요청 유형 *', selectPermissionType: '요청 유형 선택', payrollTreatment: '급여 처리 *', payrollTreatmentDescription: '승인된 날이 급여로 지급되는지 또는 지급 일수에서 차감되는지 정의합니다.', startDate: '시작일 *', endDate: '종료일 *', halfDay: '반일', halfDayDescription: '마지막 날의 반일만 요청', totalDays: '총 일수:', reason: '사유 *', reasonPlaceholder: '요청 사유를 간단히 입력하세요...', attachment: '첨부 파일 (선택)', acceptedFormats: '허용 형식: PDF, DOC, DOCX, JPG, PNG', fileTooLarge: '파일 크기는 10MB 이하여야 합니다.', uploadFile: '파일 업로드', cancel: '취소', submit: '요청 제출', submitting: '제출 중...' },
  detail: { ...enCA.detail, title: '권한 요청', employeeInformation: '직원 정보', type: '유형', payrollTreatment: '급여 처리', fallbackAttachment: 'medical-certificate-ko.pdf', startDate: '시작일', endDate: '종료일', duration: '기간', day: '일', days: '일', reason: '사유', attachments: '첨부 파일', noAttachments: '이 요청에 업로드된 첨부 파일이 없습니다.', reviewNotes: '검토 메모', reviewedBy: '검토자', reviewedAt: '검토일', created: '생성:', updated: '마지막 업데이트:' },
