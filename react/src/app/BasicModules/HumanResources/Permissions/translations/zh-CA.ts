...
export const zhCA = {
  ...
  columns: { folio: '单号', employee: '员工', type: '类型', startDate: '开始日期', endDate: '结束日期', days: '天数', status: '状态', actions: '操作' },
  pagination: {
    pageSize: '每页行数',
  ...
  filters: { title: '筛选', searchLabel: '搜索申请', searchPlaceholder: '员工或单号', status: '状态', allStatuses: '所有状态', type: '类型', allTypes: '所有类型', employee: '员工', allEmployees: '所有员工' },
  kpis: {
    total: '申请总数',
    pending: '待处理',
    approved: '已批准',
  ...
  modal: { ...enCA.modal, title: '提交许可申请', subtitle: '填写表单以提交新的许可申请。', permissionType: '许可类型 *', selectPermissionType: '选择许可类型', startDate: '开始日期 *', endDate: '结束日期 *', halfDay: '半天', halfDayDescription: '仅申请最后一天半天', totalDays: '总天数：', reason: '原因 *', reasonPlaceholder: '请简要说明申请原因...', attachment: '附件（可选）', acceptedFormats: '支持格式：PDF、DOC、DOCX、JPG、PNG', uploadFile: '上传文件', cancel: '取消', submit: '提交申请', submitting: '正在提交...' },
  detail: { ...enCA.detail, title: '许可申请', employeeInformation: '员工信息', type: '类型', fallbackAttachment: 'medical-certificate-zh.pdf', startDate: '开始日期', endDate: '结束日期', duration: '时长', day: '天', days: '天', reason: '原因', attachments: '附件', noAttachments: '此申请没有上传附件。', reviewNotes: '审核备注', reviewedBy: '审核人', reviewedAt: '审核时间', created: '创建：', updated: '最后更新：' },
