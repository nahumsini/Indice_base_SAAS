...
export function printDailyAttendanceReport({
  ...
  const updatedAt = formatDocumentPrintDateTime(new Date(), locale);
        ...
        <div class="document-topline">
          <div class="brand-lockup">
            <div class="brand-text">
              <strong>${escapePrintHtml(businessFilter ? selectedBusinessLabel : copy.timeTable.allBusinesses)}</strong>
