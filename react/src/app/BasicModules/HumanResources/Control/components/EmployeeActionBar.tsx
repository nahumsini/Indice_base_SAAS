...
export function EmployeeActionBar({
  ...
  return (
    <div className={embedded ? 'border-t border-[#59C3A5]/10 pt-4 dark:border-gray-700' : 'rounded-lg border border-[#59C3A5]/10 bg-[#F4FCF9] p-3 dark:border-gray-800 dark:bg-gray-900/30'}>
