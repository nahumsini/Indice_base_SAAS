    ...
    <aside className="min-h-0 overflow-y-auto rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
      <div className="rounded-lg border border-[#59C3A5]/20 bg-[#59C3A5]/6 p-4 dark:border-[#8FE0CA]/20 dark:bg-[#8FE0CA]/10">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs font-medium text-[#59C3A5] dark:text-[#8FE0CA]">
              {copy.pointStatus}
            </p>
            <p className="mt-2 text-xl font-medium text-slate-950 dark:text-white">
        ...
        <div className="mt-4 grid gap-3">
          <div className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white/80 px-3 py-3 dark:border-slate-700 dark:bg-slate-950/70">
            ...
            <div>
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">{copy.location}</p>
              <p className="mt-1 text-sm font-medium text-slate-950 dark:text-white">{kioskLocationLabel}</p>
            </div>
          </div>
          <div className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white/80 px-3 py-3 dark:border-slate-700 dark:bg-slate-950/70">
            ...
            <div>
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">{copy.accessPoint}</p>
              <p className="mt-1 text-sm font-medium text-slate-950 dark:text-white">{copy.pointReady}</p>
            </div>
          </div>
          <div className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white/80 px-3 py-3 dark:border-slate-700 dark:bg-slate-950/70">
            ...
            <div>
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400">{copy.currentTime}</p>
      ...
      <div className="mt-5 rounded-lg border border-slate-200 bg-slate-50/80 p-4 dark:border-slate-800 dark:bg-slate-900/70">
        <div className="mb-3 flex items-center justify-between gap-3">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs font-medium text-[#59C3A5] ring-1 ring-slate-200 dark:bg-slate-950 dark:text-[#8FE0CA] dark:ring-slate-700">
