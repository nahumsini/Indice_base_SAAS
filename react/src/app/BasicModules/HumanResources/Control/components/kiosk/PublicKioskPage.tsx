                ...
                {!identifiedEmployee ? (
                  ...
                  <div className="mt-6 space-y-6">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      ...
                      <div className={`rounded-2xl border px-4 py-3 text-sm ${faceVerificationSessionId ? 'border-emerald-200 bg-white text-emerald-700' : faceStatus === 'failed' && fallbackPhotoUpload.photo ? 'border-amber-200 bg-white text-amber-700' : 'border-slate-200 bg-white text-slate-600'}`}>
                      ...
                      <div className={`rounded-2xl border px-4 py-3 text-sm ${locationState ? 'border-emerald-200 bg-white text-emerald-700' : 'border-slate-200 bg-white text-slate-600'}`}>
                        <div className="flex items-center gap-2 font-medium">
              ...
              <aside className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                {identifiedEmployee ? (
                  <div className="space-y-5">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">{copy.face}</p>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-slate-50/90 p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm font-semibold text-slate-950">{bootstrap?.location.name ?? '—'}</p>
                        </div>
                      </div>
