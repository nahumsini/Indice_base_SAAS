...
export function PublicKioskHeader({
  ...
  return (
    <header className="border-b border-slate-200 bg-white px-4 py-3.5 dark:border-slate-800 dark:bg-slate-950">
      <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[#177D66] dark:text-[#8FE0CA]">{copy.terminalBadge}</p>
      <h1 className="mt-1 line-clamp-2 break-words text-xl font-black leading-tight tracking-tight text-slate-950 dark:text-white">{attendancePointLabel}</h1>
      <div className="mt-2 flex min-w-0 flex-wrap items-center gap-x-4 gap-y-1 text-xs font-semibold text-slate-500 dark:text-slate-400">
