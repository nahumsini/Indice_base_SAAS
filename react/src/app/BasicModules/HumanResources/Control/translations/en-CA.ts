export const enCA = {
  ...({
    ...
    labels: {
      ...
      savingAccessChangesDescription: 'Please wait while the employee access profile is updated.',
      ...
      noAvailableContractSites: 'No available contract sites for this date. Sites outside their contract window or already assigned to another employee are hidden.',
      ...
      employeeMonthlyAttendanceDetail: 'Employee monthly attendance detail',
      ...
      assignContractSiteDescription: 'Choose the external or contract location where this employee must check in for the selected dates.',
