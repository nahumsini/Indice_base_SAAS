...
export const enCA = {
  ...
  labels: {
    collaborator: 'HR User',
    employeeBrowser: 'HR User history',
    employeeBrowserHint: 'Review your HR user history before interacting with the calendar or manual recorder.',
    employeePicker: 'Selected HR user',
    previousEmployee: 'Previous',
    nextEmployee: 'Next',
    searchEmployee: 'Search HR user',
    searchPlaceholder: 'Name or code',
    employeeList: 'HR Users in scope',
    employeeListHint: 'Your monthly history and today’s record are loaded from your HR user account.',
    noEmployeesFound: 'No HR users match the current search.',
    noEmployeesAvailable: 'No HR users available yet.',
    unassignedUnit: 'No unit',
    unassignedPosition: 'No role',
    employeeSummary: 'HR User summary',
    position: 'Position',
    unit: 'Unit',
    ...
    noEmployeeSelected: 'Your HR user attendance profile is not available yet.',
    retry: 'Retry',
  ...
  recorder: {
    employee: 'HR User',
    noEmployeeSelected: 'No signed-in HR user',
    selectEmployeeHint: 'A signed-in HR user is required to enable photo and location recording.',
    photo: 'Photo',
    ...
    locationRequired: 'Capture this device location; it will be validated when you record attendance.',
    ...
    locationRequiredError: 'Capture the device location before recording attendance.',
