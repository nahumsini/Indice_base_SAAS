...
const es: PayrollRunWorkspaceText = {
  ...
  filters: 'Vista',
  fundShortageDeduction: 'Descuento pendiente por faltante de fondo',
  ...
  incentiveLoadError: 'No fue posible consultar los conceptos pendientes.',
  ...
  incentives: 'Conceptos pendientes de nómina',
  incentiveSourceNotice: 'Incluye incentivos aprobados y descuentos de fondos. Solo se aplican cuando los agregas a una corrida en borrador.',
  ...
  next: 'Siguiente',
  noIncentives: 'No hay conceptos pendientes para este periodo',
  noIncentivesDescription: 'Los incentivos aprobados y los descuentos pendientes del colaborador aparecerán aquí.',
...
const en: PayrollRunWorkspaceText = {
  ...
  filters: 'View',
  fundShortageDeduction: 'Pending fund shortage deduction',
  ...
  incentiveLoadError: 'The pending payroll items could not be loaded.',
  ...
  incentives: 'Pending payroll items',
  incentiveSourceNotice: 'Includes approved incentives and fund deductions. They are applied only when added to a draft run.',
  ...
  modified: 'Modified',
  next: 'Next',
  noIncentives: 'No pending items for this period',
  noIncentivesDescription: 'Approved incentives and pending deductions for this HR user will appear here.',
...
const fr: PayrollRunWorkspaceText = {
  ...
  exportPdfDescription: 'Rapport conçu pour la révision, l’archivage ou l’impression.', filters: 'Vue', fundShortageDeduction: 'Déduction en attente pour écart de fonds', governmentReportingDescription: 'Ouvrez les dossiers gouvernementaux vérifiables de ce cycle de paie.',
...
const pt: PayrollRunWorkspaceText = {
  ...
  exportPdfDescription: 'Relatório preparado para revisão, arquivo ou impressão.', filters: 'Visualização', fundShortageDeduction: 'Desconto pendente por falta no fundo', governmentReportingDescription: 'Abra os registros governamentais auditáveis desta folha.',
...
const ko: PayrollRunWorkspaceText = {
  ...
  exportDescription: '전체 급여를 다운로드할 형식을 선택하세요.', exportPdfDescription: '검토, 보관 또는 인쇄용 보고서입니다.', filters: '보기', fundShortageDeduction: '자금 부족 보류 공제', governmentReportingDescription: '이 급여의 감사 가능한 정부 신고 기록을 엽니다.',
...
const zh: PayrollRunWorkspaceText = {
  ...
  exportPdfDescription: '用于审核、归档或打印的报告。', filters: '视图', fundShortageDeduction: '资金短缺待处理扣款', governmentReportingDescription: '打开此薪资批次可审计的政府申报记录。', governmentReportingTitle: '哥伦比亚 PILA / DIAN',
