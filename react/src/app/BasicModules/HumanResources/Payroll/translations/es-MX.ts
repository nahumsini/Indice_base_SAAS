...
export const esMX = {
  ...enCA,
  title: 'Nómina',
  subtitle: 'Revisa, recalcula, aprueba y exporta corridas con datos reales de colaboradores y asistencia. El pago se confirma desde Gastos.',
  refresh: 'Actualizar',
  ...
  success: {
    ...
    noRunsRegenerated: 'No hay corridas en borrador para recalcular.',
    lineSaved: 'Línea de nómina actualizada correctamente.',
    runEdited: 'Corrida de nómina actualizada correctamente.',
    processed: 'Corrida de nómina recalculada; permanece en borrador.',
  ...
  busy: {
    ...
    regenerateDescription: 'Reconstruyendo corridas en borrador con las preferencias actuales. Las aprobadas y pagadas permanecen intactas.',
    saveLineTitle: 'Guardando línea de nómina',
    saveLineDescription: 'Recalculando la línea seleccionada y actualizando sus totales.',
    processTitle: 'Recalculando corrida',
    processDescription: 'Actualizando importes y asistencia; la corrida permanece en borrador.',
    approveTitle: 'Aprobando corrida',
    approveDescription: 'Congelando la corrida y creando su cuenta por pagar en Gastos.',
  ...
  labels: {
    ...
    rates: 'Tasas',
    controlPanel: 'Operación de nómina',
    ...
    noRuns: 'No hay corridas automáticas que coincidan con los filtros actuales.',
    ...
    nativeCurrencyNotice: 'La nómina fiscal se calcula en la divisa nativa del colaborador. La divisa preferida es solo una lectura consolidada estimada.',
    payrollEngineDetail: 'Cálculo del motor de nómina',
    paidLeaveAmount: 'Permiso pagado',
    unpaidAttendanceDeduction: 'Descuento por asistencia no laborada',
    sourceComputed: 'Cálculo backend',
    sourceManual: 'Ajuste manual',
    sourceTax: 'Regla fiscal y seguridad social',
    sourceIncentive: 'Incentivo aprobado',
    sourceAdjustment: 'Ajuste',
    incentiveLockedNotice: 'Los incentivos aprobados vienen del módulo de incentivos y quedan bloqueados en esta corrida.',
    ...
    close: 'Cerrar',
    generatedRuns: 'Corridas automáticas',
    ...
    imssEmployee: 'Cuota obrera IMSS',
    infonavitType: 'Tipo de crédito INFONAVIT',
  ...
  breakdown: {
    ...
    isrHint: 'El ISR se calcula antes de aplicar el subsidio para el empleo. El ISR retenido es el monto que se descuenta al colaborador.',
    formulas: {
      netFromGross: 'Neto = Bruto - Total de deducciones',
      netFromEarnings: 'Neto = Total de percepciones - Total de deducciones',
      costWithEmployer: 'Costo total de nómina = Total de percepciones + obligaciones patronales',
    ...
    rows: {
      ...
      employerImss: 'Cuota patronal IMSS',
      employerInfonavit: 'Aportación patronal INFONAVIT',
      payrollTaxStateTax: 'Impuesto sobre nóminas (ISN)',
      occupationalRisk: 'Riesgo de trabajo',
      childcareImss: 'Guarderías y prestaciones sociales',
      ...
      retroactiveAdjustments: 'Retroactivos',
      payrollCorrections: 'Correcciones',
      terminationSettlement: 'Liquidación',
      terminationIndemnity: 'Indemnización',
      severance: 'Cesantías',
  ...
  rateConfiguration: {
    ...
    mexicoCards: {
      ...
      imssEmployeeTitle: 'IMSS — Cuota obrera',
      imssEmployeeBody: 'Se calcula con base en la Ley del Seguro Social',
      imssEmployerTitle: 'IMSS — Cuota patronal',
      imssEmployerBody: 'Incluye las cuotas patronales requeridas por ley',
      infonavitEmployeeTitle: 'INFONAVIT — Descuento al trabajador',
      infonavitEmployeeHelper: 'Puede variar según las condiciones de crédito del colaborador',
      infonavitEmployerTitle: 'INFONAVIT — Aportación patronal',
      infonavitEmployerValue: '5% del salario',
      sarTitle: 'SAR — Retiro',
      sarValue: '2%',
      sarHelper: 'Aportación patronal de retiro obligatoria en México',
    },
    profiles: {
      mexico: 'México',
      canada: 'Canadá',
    ...
    fieldLabels: {
      mexico: {
        ...
        imss_user_rate: 'Cuota obrera IMSS',
        infonavit_user_rate: 'Descuento INFONAVIT',
        imss_employer_rate: 'Cuota patronal IMSS',
        infonavit_employer_rate: 'Aportación patronal INFONAVIT',
        sar_employer_rate: 'SAR - Retiro patronal',
      },
      canada: {
        isr_rate: 'Impuesto federal / provincial',
        imss_user_rate: 'CPP / QPP colaborador',
        infonavit_user_rate: 'EI colaborador',
      ...
      usa: {
        ...
        imss_user_rate: 'Seguro Social colaborador',
        infonavit_user_rate: 'Medicare / otros colaborador',
      ...
      colombia: {
        ...
        imss_user_rate: 'Salud colaborador',
        infonavit_user_rate: 'Pensión colaborador',
      ...
      brazil: {
        ...
        imss_user_rate: 'INSS colaborador',
        infonavit_user_rate: 'FGTS / otros colaborador',
      ...
      custom: {
        ...
        imss_user_rate: 'Contribución colaborador A',
        infonavit_user_rate: 'Contribución colaborador B',
  ...
  header: {
    ...
    createFirstRun: 'Crear primera nómina',
  ...
  operations: {
    ...
    insight: {
      ...
      groupedAnd: 'y',
      empty: 'Aún no hay corridas automáticas para mostrar con estos filtros.',
    },
  },
  setupGuide: {
    eyebrow: 'Configuración de nómina',
    title: 'Configura cómo deben agruparse las operaciones de nómina',
    description: 'Las corridas nacen de colaboradores, asistencia, estructura organizacional y reglas de jurisdicción. Define primero la vista operativa y deja que el motor cree las corridas correctas.',
  ...
  runActions: {
    ...
    printPayroll: 'Descargar nómina en PDF',
  ...
  editRun: {
    ...
    tableHint: 'La vista simplificada resume la nómina para revisión de negocio. Usa Nómina fiscal para controlar qué colaboradores reciben cálculos fiscales y de seguridad social.',
    total: 'Total',
    ...
    simplifiedEmployees: 'Colaboradores en nómina simplificada',
    detailedEmployees: 'Colaboradores en nómina detallada',
  },
  preferencesDialog: {
    ...
    separators: {
      frequency: {
        ...
        description: 'Colaboradores semanales, quincenales y mensuales se revisan por separado.',
      },
      workforce: {
    ...
    calendarTitle: 'Cuándo inicia y cierra cada periodo',
    calendarSubtitle: 'Configura los días de referencia que Índice usa para crear corridas automáticas en borrador.',
    weeklyStartDay: 'Inicio semanal',
    biweeklyFirstDay: 'Primer inicio quincenal',
    biweeklySecondDay: 'Segundo inicio quincenal',
    monthlyStartDay: 'Inicio mensual',
    dayOfMonthHelper: 'Día del mes',
    weeklyHelper: 'Las corridas semanales cierran 6 días después del inicio seleccionado.',
    biweeklyHelper: 'Las corridas quincenales cierran el día anterior al siguiente corte configurado.',
    monthlyHelper: 'Las corridas mensuales cierran el día anterior al siguiente inicio mensual. Si el mes es más corto, Índice usa el último día disponible.',
    weekDays: [
      { value: 1, label: 'Lunes' },
  ...
  rateDialog: {
    ...
    mexicoOverview: 'ISR: se calcula usando tablas fiscales oficiales. IMSS: se aplica automáticamente. INFONAVIT: depende de las condiciones del colaborador. SAR: es fijo por ley.',
