export const enCA = {
  ...
  setupGuide: {
    ...
    description: 'Payroll runs are created from employee records, attendance, organizational structure, and jurisdiction rules. Choose the operational view first, then let the payroll engine create the correct runs.',
  ...
  editRun: {
    noRows: 'No employees available for this run.',
    ...
    tableHint: 'Simplified view summarizes payroll for business review. Use Statutory Payroll to control which employees receive tax and social security calculations.',
    total: 'Total',
    ...
    simplifiedEmployees: 'Simplified Payroll Employees',
    detailedEmployees: 'Detailed Payroll Employees',
  },
  preferencesDialog: {
  ...
  rateDialog: {
    ...
    mexicoOverview: 'Income tax (ISR): calculated using official tax tables. Social security (IMSS): automatically applied. Housing (INFONAVIT): depends on employee conditions. Retirement (SAR): fixed by law.',
