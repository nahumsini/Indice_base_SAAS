export const enCA = {
  title: 'Payroll',
  subtitle: 'Review, recalculate, approve, and export payroll runs using real HR user and attendance data. Payment is confirmed from Expenses.',
  refresh: 'Refresh',
  ...
  success: {
    ...
    noRunsRegenerated: 'There are no draft payroll runs to recalculate.',
    lineSaved: 'Payroll line updated successfully.',
    runEdited: 'Payroll run updated successfully.',
    processed: 'Payroll run recalculated and kept as draft.',
  ...
  busy: {
    ...
    refreshDescription: 'Reloading payroll runs, preferences, and automatic totals.',
    ...
    regenerateDescription: 'Rebuilding draft payroll runs from current preferences. Approved and paid runs remain locked.',
    saveLineTitle: 'Saving payroll line',
    saveLineDescription: 'Recalculating the selected line and updating totals.',
    processTitle: 'Recalculating payroll run',
    processDescription: 'Updating amounts and attendance while keeping the run as draft.',
    approveTitle: 'Approving payroll run',
    approveDescription: 'Locking the run and creating its payable in Expenses.',
  ...
  exchangeRates: {
    ...
    dailyResetNote: 'Loading the daily rate replaces any manual rate with the available daily reference.',
    dailySource: 'Internal daily reference',
    invalid: 'Enter rates greater than zero.',
    manualMode: 'Manual permanent',
    manualPersistenceNote: 'When applied, this rate remains saved and will be used until you edit it or load the daily rate.',
  ...
  labels: {
    ...
    rates: 'Rates',
    controlPanel: 'Payroll operations',
    frequency: 'Frequency',
    period: 'Period',
    ...
    all: 'All',
    runs: 'Payroll runs',
    noRuns: 'No automatic payroll runs match the current filters.',
    employees: 'HR Users',
    gross: 'Gross',
    ...
    noAttendanceRecords: 'Missing attendance records',
    nativeCurrencyNotice: 'Fiscal payroll is calculated in the HR user native currency. The preferred currency is only a consolidated display estimate.',
    payrollEngineDetail: 'Payroll engine calculation',
    paidLeaveAmount: 'Paid leave',
    unpaidAttendanceDeduction: 'Unpaid attendance deduction',
    sourceComputed: 'Backend calculation',
    sourceManual: 'Manual adjustment',
    sourceTax: 'Tax and social security rule',
    sourceIncentive: 'Approved incentive',
    sourceAdjustment: 'Adjustment',
    incentiveLockedNotice: 'Approved incentives come from the incentives module and are locked in this payroll run.',
  ...
  breakdown: {
    ...
    rows: {
      ...
      payrollCorrections: 'Payroll corrections',
      terminationSettlement: 'Termination settlement',
      terminationIndemnity: 'Termination indemnity',
      severance: 'Severance',
  ...
  header: {
    ...
    createFirstRun: 'Create first payroll',
  ...
  operations: {
    ...
    insight: {
      ...
      groupedAnd: 'and',
      empty: 'No automatic payroll runs are available for these filters yet.',
    },
  },
  setupGuide: {
  ...
  runActions: {
    ...
    printPayroll: 'Download payroll PDF',
  ...
  preferencesDialog: {
    ...
    calendarTitle: 'When payroll periods open and close',
    calendarSubtitle: 'Set the reference days Índice uses to create automatic draft payroll runs.',
    weeklyStartDay: 'Weekly start day',
    biweeklyFirstDay: 'First biweekly start day',
    biweeklySecondDay: 'Second biweekly start day',
    monthlyStartDay: 'Monthly start day',
    dayOfMonthHelper: 'Day of month',
    weeklyHelper: 'Weekly runs close 6 days after the selected start day.',
    biweeklyHelper: 'Biweekly runs close the day before the next configured cutoff.',
    monthlyHelper: 'Monthly runs close the day before the next monthly start. If a month is shorter, Índice uses the last day of that month.',
    weekDays: [
