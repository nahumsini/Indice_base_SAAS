...
const bulkSelectClass =
  'h-9 min-w-[150px] rounded-xl border border-slate-200 bg-white px-3 text-sm font-medium text-slate-700 shadow-none outline-none transition hover:bg-slate-50 focus:border-[#147514]/40 focus:ring-2 focus:ring-[#147514]/10 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100';
    ...
    <section className="sticky bottom-[calc(1rem+env(safe-area-inset-bottom))] z-30 mb-4 rounded-2xl border border-[#147514]/25 bg-[#147514]/10 px-4 py-3 shadow-lg shadow-slate-950/10 backdrop-blur dark:border-[#147514]/40 dark:bg-[#147514]/15 sm:static sm:shadow-sm sm:backdrop-blur-0">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-wrap items-center gap-2 text-sm font-medium text-slate-800 dark:text-slate-100">
          <span className="rounded-full border border-[#147514]/30 bg-white px-3 py-1 text-sm font-medium text-[#147514] dark:bg-slate-800 dark:text-emerald-200">
