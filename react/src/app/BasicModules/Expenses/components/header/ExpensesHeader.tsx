import { Columns3, Landmark, Plus, TableProperties } from 'lucide-react';
...
export function ExpensesHeader({
  ...
  const ActionLayout = () => (
    <div className="grid grid-cols-1 gap-2 sm:flex sm:flex-row sm:flex-wrap sm:items-center lg:justify-end">
      <Button onClick={onConfigureColumns} variant="outline" className="h-11 w-full justify-center gap-2 whitespace-nowrap rounded-xl border-slate-200 bg-white px-4 text-sm font-medium text-slate-700 shadow-none hover:border-[#147514]/30 hover:bg-[#147514]/5 hover:text-[#147514] dark:border-slate-700 dark:bg-slate-800 dark:text-white sm:w-auto">
