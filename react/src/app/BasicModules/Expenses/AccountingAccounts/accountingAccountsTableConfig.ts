...
export const defaultAccountingColumns: AccountingColumnConfig[] = [
  ...
  { key: 'countryCode', label: 'País', description: 'País origen del catálogo base.', sortField: 'countryCode', visible: true },
  { key: 'localStandard', label: 'Estándar', description: 'Referencia normativa o fiscal local.', sortField: 'localStandard', visible: true },
  { key: 'statementSection', label: 'Sección', description: 'Sección canónica del estado financiero.', sortField: 'statementSection', visible: true },
  ...
  { key: 'description', label: 'Descripción', description: 'Uso esperado de la cuenta.', sortField: 'description', visible: true },
  { key: 'balance', label: 'Saldo', description: 'Saldo informativo asociado.', sortField: 'balance', visible: true },
