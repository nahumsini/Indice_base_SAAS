  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-[minmax(280px,1.4fr)_repeat(2,minmax(0,1fr))]">
        ...
        <FilterSelect label="Tipo de cuenta" value={typeFilter} onChange={onTypeChange} options={[{ value: 'all', label: 'Todos los tipos' }, ...typeOptions]} />
  ...
  return (
    <label className="min-w-0">
      ...
      <div className="relative">
        ...
        <input type="text" value={searchTerm} onChange={(event) => onSearchChange(event.target.value)} placeholder="Código, nombre o descripción" className="h-11 w-full rounded-xl border border-slate-200 bg-white py-2 pl-10 pr-10 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-[#147514] focus:ring-2 focus:ring-[#147514]/15 dark:border-slate-700 dark:bg-slate-900 dark:text-white" />
