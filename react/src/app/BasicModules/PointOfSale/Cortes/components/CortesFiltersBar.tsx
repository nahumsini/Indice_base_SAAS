  ...
  return (
    <label className="space-y-2">
      ...
      <input
        ...
        className="h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-950 outline-none transition focus:border-[#FF6B5E] focus:ring-2 focus:ring-[#FF6B5E]/20 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
      />
    </label>
  );
}
    ...
    <label className="space-y-2 md:col-span-2 xl:col-span-2">
      ...
      <span className="relative block">
        ...
        <input
          ...
          className="h-11 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-3 text-sm font-semibold text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-[#FF6B5E] focus:ring-2 focus:ring-[#FF6B5E]/20 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
        />
      </span>
    </label>
  );
