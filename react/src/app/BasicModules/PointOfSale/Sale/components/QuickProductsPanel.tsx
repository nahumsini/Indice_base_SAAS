      ...
      <div className="border-b border-[#222831]/10 bg-[#222831] px-5 py-4 text-white dark:border-gray-700 dark:bg-[#111827]">
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-start gap-3">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#FF6B5E]/20 text-white dark:bg-[#FF6B5E]/15" aria-hidden="true">
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          ...
          <label className="relative block w-full lg:w-[340px] xl:w-[380px]">
            ...
            <input
              ...
              className="min-h-12 w-full rounded-2xl border border-gray-200 bg-white pl-12 pr-11 text-sm font-bold text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-[#FF6B5E] focus:ring-4 focus:ring-[#FF6B5E]/15 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
            />
            {quickSearch ? (
              <button
                type="button"
                onClick={() => setQuickSearch('')}
                className="absolute right-2 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-xl text-gray-400 transition hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-white"
