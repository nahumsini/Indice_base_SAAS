    ...
    >
      <div className="space-y-5">
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
          ...
          <p className="mt-1 text-3xl font-medium text-gray-950 dark:text-white">
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Metodos de pago</h3>
          <PaymentAmountField
    ...
    <div className={`rounded-lg border-2 p-4 ${toneClass}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="0.00"
          className="min-h-12 w-full rounded-lg border border-white/60 bg-white py-2.5 pl-8 pr-16 text-lg font-medium text-gray-900 focus:ring-2 focus:ring-orange-500 dark:border-gray-700 dark:bg-gray-950 dark:text-white"
        />
        {suffix ? (
