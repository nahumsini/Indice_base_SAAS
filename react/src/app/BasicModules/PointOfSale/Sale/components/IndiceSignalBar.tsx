...
export function IndiceSignalBar({
  ...
  return (
    <section className="rounded-xl border border-[#FF6B5E]/25 bg-[#FF6B5E]/[0.06] px-4 py-3 dark:border-[#FF6B5E]/30 dark:bg-[#FF6B5E]/10">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex min-w-0 items-center gap-3">
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#FF6B5E]/20 text-[#B63B32] dark:text-[#FFB0AA]">
            <Activity className="h-5 w-5" />
          </span>
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="text-sm font-medium text-[#222831] dark:text-white">Señal Indice</h3>
              <span className="rounded-full border border-[#FF6B5E]/20 bg-white px-2.5 py-1 text-xs font-medium text-[#B63B32] dark:bg-gray-900 dark:text-[#FFB0AA]">
                Control retail
              </span>
            </div>
...
function SignalChip({
  ...
  const toneClass = {
    control: 'border-[#FF6B5E]/25 bg-white text-[#B63B32] dark:border-[#FF6B5E]/30 dark:bg-gray-900 dark:text-[#FFB0AA]',
  ...
  return (
    <span className={`inline-flex min-h-10 items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium ${toneClass}`}>
