    ...
    >
      <div className="space-y-5">
        <section className="rounded-lg border border-blue-200 bg-blue-50 p-5 text-center dark:border-blue-500/30 dark:bg-blue-500/10">
          <p className="text-sm font-medium text-blue-700 dark:text-blue-200">Total a transferir</p>
        ...
        <section className="space-y-3 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Datos para transferencia</h3>
    ...
    <div className="rounded-lg bg-gray-50 p-3 dark:bg-gray-950/50">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{label}</p>
          <p className="mt-1 break-all font-mono font-medium text-gray-900 dark:text-white">{value}</p>
        </div>
        <button
          type="button"
          onClick={onCopy}
