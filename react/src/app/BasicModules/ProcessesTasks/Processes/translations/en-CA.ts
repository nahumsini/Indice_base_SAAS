...
export const enCA = {
  ...
  header: {
    emoji: '🔄',
    title: 'Processes',
    subtitle: 'Design recurring or occasional processes that generate real agenda tasks for one person or a team.',
    actions: {
      table: 'Table',
      diagram: 'Diagram',
      columns: 'Columns',
  ...
  form: {
    ...
    descriptions: {
      create: 'Design an individual or shared process and choose whether it runs on a schedule or on demand.',
    ...
    sections: {
      ...
      engineControl: 'Process validity',
      engineDescription: 'Define when generation starts and how long the recurring process remains in effect.',
  ...
  confirmation: {
    ...
    deleteDescription: 'This removes the process from the active catalog. Runs and tasks already created remain unchanged as history.',
