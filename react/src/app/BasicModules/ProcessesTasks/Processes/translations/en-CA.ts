...
export const enCA = {
  ...
  fixedColumns: {
    actions: {
      label: 'Actions',
      description: 'Buttons to run, pause, edit, copy, or delete the process.',
    },
  },
  table: {
  ...
  confirmation: {
    ...
    deleteDescription: 'This removes the process from the active catalog with soft delete and keeps the backend data backup.',
