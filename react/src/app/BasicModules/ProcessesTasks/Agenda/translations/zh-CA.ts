...
export const zhCA: AgendaTranslations = {
  ...
  schedule: {
    ...
    weekTitle: '每周计划',
    listTitle: '每周列表',
    daySubtitle: '按执行顺序和时间整理可见任务。',
    weekSubtitle: '查看每周工作量，在日期之间移动任务，并保持清晰的执行顺序。',
    viewDay: '日',
    viewWeek: '周',
    viewList: '列表',
    today: '今天',
    planColumn: '工作计划',
    noHourLabel: '无时间',
    dayDropPlaceholder: '将任务拖到这里',
    emptyListDay: '没有已安排任务',
    dayBadge: (count: number) => `今天 ${count} 项`,
    weekBadge: (count: number) => `本周 ${count} 项`,
    plannedBadge: (count: number) => `已计划 ${count} 项`,
