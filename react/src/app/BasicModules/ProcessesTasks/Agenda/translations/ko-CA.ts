...
export const koCA: AgendaTranslations = {
  ...
  schedule: {
    ...
    weekTitle: '주간 계획표',
    listTitle: '주간 목록',
    daySubtitle: '보이는 작업을 실행 순서와 시간에 따라 정리하세요.',
    weekSubtitle: '주간 업무량을 검토하고 작업을 날짜 사이로 이동해 실행 순서를 명확하게 유지하세요.',
    viewDay: '일',
    viewWeek: '주',
    viewList: '목록',
    today: '오늘',
    planColumn: '업무 계획',
    noHourLabel: '시간 없음',
    dayDropPlaceholder: '여기에 작업을 끌어놓으세요',
    emptyListDay: '예약된 작업 없음',
    dayBadge: (count: number) => `오늘 ${count}개`,
    weekBadge: (count: number) => `이번 주 ${count}개`,
    plannedBadge: (count: number) => `계획됨 ${count}개`,
    tasksCount: (count: number) => `작업 ${count}개`,
  },
  messages: {
