...
const es: StandardUiCopy = {
  title: 'Indicadores de procesos y tareas', subtitle: 'Productividad, cumplimiento, riesgo y rendimiento operativo por vistas.',
  ...
  cards: {
    ...
    timeliness: { title: 'Sin estado vencido en Agenda', target: (s) => `${s.overdueTasks} vencidas`, description: 'Proporción sin estado vencido en Agenda; no mide entregas a tiempo.' },
    ...
    evidence: { title: 'Tareas con archivos', target: (s) => `${s.evidenceTasks} con archivos`, description: 'Cobertura documental de las tareas incluidas en el alcance.' },
  ...
  topCompliance: 'Mayor índice operativo', topOverdue: 'Vencidas por responsable', riskyProcesses: 'Procesos que requieren atención', riskyProjects: 'Proyectos que requieren atención',
  noData: 'Sin datos en el alcance actual', tasks: 'tareas', score: 'puntos',
};

const en: StandardUiCopy = {
  ...es,
  title: 'Process and task indicators', subtitle: 'Productivity, compliance, risk, and operational performance by view.',
  ...
  cards: {
    ...
    timeliness: { title: 'Without overdue Agenda status', target: (s) => `${s.overdueTasks} overdue`, description: 'Share without overdue Agenda status; does not measure on-time delivery.' },
    ...
    evidence: { title: 'Tasks with attachments', target: (s) => `${s.evidenceTasks} with files`, description: 'Document coverage for tasks included in the scope.' },
  ...
  topCompliance: 'Highest operational index', topOverdue: 'Overdue by owner', riskyProcesses: 'Processes requiring attention', riskyProjects: 'Projects requiring attention',
