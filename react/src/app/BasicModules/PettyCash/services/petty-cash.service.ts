...
const toFund = (dto: PettyCashFundApiDto): PettyCashFund => ({
  ...
  businessName: customString(dto.customFields, 'businessName') ?? labelWithId('Negocio', dto.businessId),
  companyId: idString(dto.companyId),
  createdByName: customString(dto.customFields, 'createdByName') ?? labelWithId('Usuario', dto.createdByUserId),
  ...
  fundingSourceName: dto.fundingSourceName ?? customString(dto.customFields, 'fundingSourceName') ?? 'Cuenta financiera',
  ...
  responsibleName: customString(dto.customFields, 'responsibleName') ?? labelWithId('Usuario', dto.responsibleUserId),
  responsibleUserId: idString(dto.responsibleUserId),
  spendingMethods: dto.spendingMethods ?? [],
  status: dto.status ?? 'OPEN',
  unitId: idString(dto.unitId),
  unitName: customString(dto.customFields, 'unitName') ?? labelWithId('Unidad', dto.unitId),
});
...
const toStatement = (
  ...
  return {
    ...
    responsibleName: customString(dto.customFields, 'responsibleName') ?? fund?.responsibleName ?? labelWithId('Usuario', dto.responsibleUserId),
    responsibleUserId: idString(dto.responsibleUserId),
    returnedAmount: asNumber(dto.returnedAmount),
    reviewedByName: customString(dto.customFields, 'reviewedByName') ?? optionalLabelWithId('Usuario', dto.reviewedByUserId),
...
const toMovement = (
  ...
  return {
    ...
    fromPaymentAccountName: customString(dto.customFields, 'fromPaymentAccountName') ?? labelWithId('Cuenta', dto.fromPaymentAccountId),
    movementDate: dto.movementDate,
    pettyCashFundId: idString(dto.pettyCashFundId),
    pettyCashStatementId: idString(dto.pettyCashStatementId),
    reference: dto.reference ?? '',
    toPaymentAccountId: idString(dto.toPaymentAccountId),
    toPaymentAccountName: customString(dto.customFields, 'toPaymentAccountName') ?? fund?.name ?? labelWithId('Cuenta', dto.toPaymentAccountId),
    type: dto.type,
  };
};
...
const toSettlementLine = (dto: PettyCashSettlementLineApiDto): PettyCashSettlementLine => ({
  ...
  accountingAccountName: customString(dto.customFields, 'accountingAccountName') ?? optionalLabelWithId('Cuenta contable', dto.accountingAccountId),
  attachmentCount: dto.attachmentCount ?? 0,
  companyId: idString(dto.companyId),
  currencyCode: asCurrency(dto.currencyCode),
  ...
  providerName: customString(dto.customFields, 'providerName') ?? optionalLabelWithId('Proveedor', dto.providerId),
