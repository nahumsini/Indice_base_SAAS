...
export default function PublicPettyCashKioskPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-6 text-slate-900">
      <div className="mx-auto flex w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-[#147514]/25 bg-white shadow-2xl">
        ...
        {errorMessage ? (
          <div className="border-b border-red-200 bg-red-50 px-6 py-4 text-sm font-bold text-red-700">
            {errorMessage}
          </div>
        ) : null}

        {successMessage ? (
          <div className="border-b border-emerald-200 bg-emerald-50 px-6 py-4 text-sm font-bold text-emerald-700">
            {successMessage}
          </div>
        ) : null}
        ...
        <div className="grid gap-6 p-6 lg:grid-cols-[minmax(0,1fr)_320px]">
          {!identity ? (
            <section className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <div className="flex items-start gap-3">
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-emerald-50 text-[#147514]">
              ...
              <div className="mt-6 max-w-sm">
                ...
                />
                <button
                  className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-[#147514] px-5 py-3 text-sm font-black text-white shadow-sm transition hover:bg-[#0f5f0f] disabled:cursor-not-allowed disabled:opacity-50"
          ...
          <aside className="space-y-4">
            <section className="rounded-2xl border border-slate-200 bg-white p-5">
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-50 text-[#147514]">
              ...
              {recentReceipts.length === 0 ? (
                ...
                <div className="mt-4 grid gap-3">
                  {recentReceipts.map(receipt => (
                    <div key={receipt.id} className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-3">
