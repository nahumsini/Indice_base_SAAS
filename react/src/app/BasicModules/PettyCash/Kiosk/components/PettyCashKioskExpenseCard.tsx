    ...
    <article className="w-full rounded-2xl border border-[#147514]/20 bg-white p-3 shadow-[0_12px_28px_-28px_rgba(15,23,42,0.9)] dark:border-emerald-400/20 dark:bg-slate-950">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[#147514]/75 dark:text-emerald-300/75">{date}</p>
          <h3 className="mt-1 line-clamp-2 text-sm font-semibold leading-5 text-slate-950 dark:text-white">{receipt.description}</h3>
        </div>
        <p className="shrink-0 text-sm font-semibold text-rose-600 dark:text-rose-300">{amount}</p>
      </div>

      <div className="mt-2 grid grid-cols-2 gap-2">
        <div className="min-w-0 rounded-xl bg-white px-2.5 py-2 dark:bg-slate-900">
          <p className="text-[9px] font-semibold uppercase tracking-[0.08em] text-slate-400">{referenceLabel}</p>
        ...
        <div className="min-w-0 rounded-xl bg-white px-2.5 py-2 dark:bg-slate-900">
          <p className="text-[9px] font-semibold uppercase tracking-[0.08em] text-slate-400">{statusTitle}</p>
      ...
      <div className="mt-2.5 flex items-center gap-2 border-t border-slate-200 pt-2.5 dark:border-slate-700">
        <button
          className="inline-flex min-h-10 min-w-0 flex-1 items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-700 transition hover:border-[#147514]/30 hover:text-[#147514] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#147514]/15 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
