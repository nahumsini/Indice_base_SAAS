    ...
    <article className="w-full rounded-2xl border border-[#147514]/20 bg-white p-3 shadow-[0_12px_28px_-28px_rgba(15,23,42,0.9)] dark:border-emerald-400/20 dark:bg-slate-950">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-emerald-700/70 dark:text-emerald-300/70">{date}</p>
          <h3 className="mt-1 truncate text-sm font-semibold leading-5 text-slate-950 dark:text-white">{title}</h3>
        </div>
        <p className="shrink-0 text-sm font-semibold text-[#147514] dark:text-emerald-300">{amount}</p>
      </div>
