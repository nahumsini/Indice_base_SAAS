...
export function ConnectionTrustStrip({ copy }: { copy: IntegrationsTranslations }) {
  ...
  return (
    <section className="rounded-xl border border-[#2563EB]/30 bg-[#2563EB]/5 p-4 dark:border-[#2563EB]/35 dark:bg-[#2563EB]/10">
      <div className="mb-4">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        {items.map(({ icon: Icon, label, description }) => (
          <div key={label} className="flex items-start gap-3 rounded-xl border border-white/80 bg-white/80 p-3 dark:border-slate-700 dark:bg-slate-900/80">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#2563EB]/10 text-[#2563EB] dark:text-[#93C5FD]">
