...
export const zhCA: ConsultingTranslations = {
  ...
  consultantPreference: '您希望由谁提供咨询？', consultantPreferenceDescription: '您的偏好将用于安排顾问。Indice 团队会确认可用情况，您也可以申请更换。', distributorPreferenceTitle: '我的分销合作伙伴', distributorPreferenceDescription: '申请由您的分销合作伙伴或其团队顾问提供服务。', indiceTeamPreferenceTitle: '其他 Indice 顾问', indiceTeamPreferenceDescription: '由 Indice 根据主题和时间安排其他顾问。', requestedWith: '申请偏好',
  ...
  requiredMessage: '请先填写必填信息。', preferenceRequiredMessage: '请选择您的分销合作伙伴或其他 Indice 顾问。', invalidDateMessage: '请选择至少提前 24 小时的工作时段。', locationRequiredMessage: '请选择提供线下服务的城市，或改为线上咨询。', notificationWarning: '请求已保存，但邮件通知发送失败。团队仍可在 Root 中查看。',
