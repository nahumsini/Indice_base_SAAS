...
export const koCA: ConsultingTranslations = {
  ...
  scheduleTitle: '상담 요청', scheduleDescription: '먼저 가능한 시간을 알려 주세요. 그다음 가장 적합한 지원 방법을 함께 정합니다.', stepSession: '2 · 방식', stepTime: '1 · 날짜 및 시간', stepContext: '3 · 주제 및 연락처', includedBadge: '계정에 포함됨', additionalBadge: '별도 결제 필요',
  ...
  requiredMessage: '계속하기 전에 필수 항목을 입력하세요.', invalidDateMessage: '최소 24시간 이후의 업무 시간대를 선택하세요.', locationRequiredMessage: '대면 서비스가 제공되는 도시를 선택하거나 온라인 상담으로 변경하세요.', notificationWarning: '요청은 저장되었지만 이메일 알림을 보내지 못했습니다. Root에서 팀이 요청을 확인할 수 있습니다.',
