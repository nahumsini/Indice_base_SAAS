...
const enCA: MultiKioskAdminCopy = {
  ...
  editor: {
    ...
    addTool: name => `Add ${name}`, removeTool: name => `Remove ${name}`,
...
const esMX: MultiKioskAdminCopy = {
  ...
  editor: {
    ...
    removeTool: name => `Quitar ${name}`, moveUp: name => `Subir ${name}`, moveDown: name => `Bajar ${name}`,
  },
};
