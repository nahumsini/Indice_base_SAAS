...
const messages = {
  accessGrant: ["Grant courtesy access", "Conceder cortesía", "Offrir un accès", "Conceder cortesia", "무료 이용권 부여", "授予赠送权限"],
  accessRemove: ["Withdraw courtesy access", "Retirar cortesía", "Retirer l’accès offert", "Retirar cortesia", "무료 이용권 취소", "撤销赠送权限"],
  accessManageCapacity: ["Adjust capacity", "Ajustar capacidad", "Ajuster la capacité", "Ajustar capacidade", "용량 조정", "调整容量"],
  accessCapacity: ["Courtesy capacity", "Capacidad de cortesía", "Capacité offerte", "Capacidade de cortesia", "무료 제공 용량", "赠送容量"],
  accessCapacityHelp: ["Additional user seats and storage granted to this customer.", "Lugares de usuario y almacenamiento adicionales concedidos a este cliente.", "Places et stockage supplémentaires offerts à ce client.", "Vagas de usuários e armazenamento adicionais concedidos a este cliente.", "이 고객에게 부여된 추가 사용자 자리 및 저장 공간입니다.", "授予此客户的额外用户名额和存储空间。"],
  accessExtraSeats: ["{count} additional user seats", "{count} lugares de usuario adicionales", "{count} places supplémentaires", "{count} vagas de usuários adicionais", "추가 사용자 자리 {count}개", "{count} 个额外用户名额"],
  accessStorageBlocks: ["{count} additional storage blocks", "{count} bloques de almacenamiento adicionales", "{count} blocs de stockage supplémentaires", "{count} blocos de armazenamento adicionais", "추가 저장 블록 {count}개", "{count} 个额外存储块"],
  accessRevokeProductEffect: ["This withdraws all {count} grants recorded as active for this product, including grants with future dates. Access provided by a subscription or another package remains. The action is recorded in history.", "Se retirarán las {count} concesiones registradas como activas de este producto, incluidas las de fechas futuras. Se conserva el acceso que aporte una suscripción u otro paquete. La acción quedará en el historial.", "Les {count} attributions actives de ce produit seront retirées, y compris celles à venir. Les accès fournis par un abonnement ou un autre forfait sont conservés. L’action sera enregistrée.", "Serão retiradas as {count} concessões registradas como ativas deste produto, inclusive futuras. O acesso por assinatura ou outro pacote permanece. A ação será registrada.", "향후 날짜를 포함하여 이 상품에 활성으로 기록된 이용권 {count}개가 모두 취소됩니다. 구독이나 다른 패키지의 접근은 유지됩니다. 작업이 기록됩니다.", "将撤销此产品所有 {count} 项标记为有效的授权，包括未来授权。订阅或其他套餐提供的权限保留。此操作将记录在历史中。"],
  accessRevokeSeatsEffect: ["This withdraws the grant of {count} additional user seats. Effective capacity will be recalculated. User accounts are not deleted and billing is unchanged.", "Se retirará la concesión de {count} lugares adicionales y se recalculará la capacidad vigente. No se eliminan usuarios ni se modifica la facturación.", "L’attribution de {count} places sera retirée et la capacité recalculée. Les utilisateurs et la facturation restent inchangés.", "A concessão de {count} vagas será retirada e a capacidade recalculada. Usuários e faturamento permanecem inalterados.", "추가 자리 {count}개 부여를 취소하고 유효 용량을 다시 계산합니다. 사용자 계정과 청구는 변경되지 않습니다.", "将撤销 {count} 个额外名额的授权并重新计算有效容量。不会删除用户或更改账单。"],
  accessRevokeStorageEffect: ["This withdraws the grant of {count} storage blocks. Effective capacity will be recalculated. Stored files are not deleted and billing is unchanged.", "Se retirará la concesión de {count} bloques de almacenamiento y se recalculará la capacidad vigente. No se eliminan archivos ni se modifica la facturación.", "L’attribution de {count} blocs sera retirée et la capacité recalculée. Les fichiers et la facturation restent inchangés.", "A concessão de {count} blocos será retirada e a capacidade recalculada. Arquivos e faturamento permanecem inalterados.", "저장 블록 {count}개 부여를 취소하고 유효 용량을 다시 계산합니다. 저장 파일과 청구는 변경되지 않습니다.", "将撤销 {count} 个存储块的授权并重新计算有效容量。不会删除文件或更改账单。"],
  accessDetails: ["Access details", "Detalle del acceso", "Détails de l’accès", "Detalhes do acesso", "접근 세부 정보", "权限详情"],
  accessValidity: ["Validity", "Vigencia", "Validité", "Vigência", "유효 기간", "有效期"],
  accessModulesHelp: ["Review each module, its access source and validity. Open its details for the administrative record.", "Consulta cada módulo, el origen de su acceso y su vigencia. Abre el detalle para ver sus registros administrativos.", "Consultez chaque module, sa source d’accès et sa validité. Ouvrez les détails pour les enregistrements administratifs.", "Consulte cada módulo, a origem do acesso e a vigência. Abra os detalhes para os registros administrativos.", "모듈별 접근 출처와 유효 기간을 확인하세요. 관리 기록은 세부 정보에서 확인할 수 있습니다.", "查看各模块、权限来源和有效期。展开详情查看管理记录。"],
  accessAvailableModules: ["Available modules ({count})", "Módulos disponibles ({count})", "Modules disponibles ({count})", "Módulos disponíveis ({count})", "사용 가능한 모듈 ({count})", "可用模块（{count}）"],
  accessContractChange: ["Change subscription", "Cambiar contratación", "Modifier l’abonnement", "Alterar contratação", "구독 변경", "更改订阅"],
  accessContractAdd: ["Add to subscription", "Agregar a contratación", "Ajouter à l’abonnement", "Adicionar à contratação", "구독에 추가", "添加到订阅"],
  accessContractRemove: ["Remove from subscription", "Retirar de contratación", "Retirer de l’abonnement", "Retirar da contratação", "구독에서 제거", "从订阅移除"],
  accessFormHelp: ["Choose the benefit, its validity and the reason. This administrative grant does not create an automatic charge.", "Elige el beneficio, su vigencia y el motivo. Esta concesión administrativa no genera un cobro automático.", "Choisissez l’avantage, sa validité et le motif. Cette attribution administrative ne crée aucun débit automatique.", "Escolha o benefício, a vigência e o motivo. Esta concessão administrativa não gera cobrança automática.", "혜택, 유효 기간, 사유를 선택하세요. 이 관리 부여로 자동 요금이 발생하지 않습니다.", "选择权益、有效期和原因。此管理授权不会自动扣费。"],
  accessSeatQuantity: ["Additional user seats to grant", "Lugares de usuario que se agregarán", "Places supplémentaires à offrir", "Vagas de usuários a adicionar", "부여할 추가 사용자 자리", "要授予的额外用户名额"],
  accessStorageQuantity: ["Storage blocks to grant", "Bloques de almacenamiento que se agregarán", "Blocs de stockage à offrir", "Blocos de armazenamento a adicionar", "부여할 저장 블록", "要授予的存储块"],
  accessTemporary: ["With an end date", "Con fecha de vencimiento", "Avec une date de fin", "Com data de vencimento", "종료 날짜 있음", "设置截止日期"],
  accessPermanent: ["No expiration", "Sin vencimiento", "Sans expiration", "Sem vencimento", "만료 없음", "无到期日"],
  accessPermanentHelp: ["This grant remains until an administrator withdraws it.", "Esta concesión se mantiene hasta que un administrador la retire.", "Cette attribution reste valable jusqu’à son retrait par un administrateur.", "Esta concessão permanece até um administrador retirá-la.", "관리자가 취소할 때까지 이 부여가 유지됩니다.", "此授权持续有效，直到管理员撤销。"],
  accessDiscardTitle: ["Discard pending changes?", "¿Descartar los cambios pendientes?", "Abandonner les modifications?", "Descartar as alterações pendentes?", "변경 사항을 취소할까요?", "放弃待处理的更改？"],
  accessDiscardHelp: ["Your changes have not been applied. Keep editing or discard them to return.", "Tus cambios todavía no se han aplicado. Puedes seguir editando o descartarlos para regresar.", "Vos modifications ne sont pas appliquées. Continuez ou abandonnez-les pour revenir.", "Suas alterações ainda não foram aplicadas. Continue editando ou descarte para voltar.", "변경 사항이 아직 적용되지 않았습니다. 계속 편집하거나 취소하고 돌아가세요.", "更改尚未应用。可继续编辑或放弃并返回。"],
  accessKeepEditing: ["Keep editing", "Seguir editando", "Continuer à modifier", "Continuar editando", "계속 편집", "继续编辑"],
  accessDiscard: ["Discard changes", "Descartar cambios", "Abandonner les modifications", "Descartar alterações", "변경 취소", "放弃更改"],
  accessInvalidEnd: ["Choose a future end date.", "Elige una fecha de vencimiento futura.", "Choisissez une date de fin future.", "Escolha uma data de vencimento futura.", "미래 종료 날짜를 선택하세요.", "请选择未来的截止日期。"],
  accessNoEligibleProducts: ["All available modules already have access. Review existing access in the customer file.", "Todos los módulos disponibles ya tienen acceso. Revisa los accesos existentes en la ficha del cliente.", "Tous les modules disponibles ont déjà un accès. Consultez le dossier client.", "Todos os módulos disponíveis já têm acesso. Consulte a ficha do cliente.", "모든 사용 가능한 모듈에 접근 권한이 있습니다. 고객 정보에서 확인하세요.", "所有可用模块已获得权限。请在客户资料中查看现有权限。"],
  accessUsersSummary: ["Users: {active} active · {reserved} invited · Capacity: {capacity}", "Usuarios: {active} activos · {reserved} invitados · Capacidad: {capacity}", "Utilisateurs : {active} actifs · {reserved} invités · Capacité : {capacity}", "Usuários: {active} ativos · {reserved} convidados · Capacidade: {capacity}", "사용자: 활성 {active}명 · 초대 {reserved}명 · 정원 {capacity}명", "用户：{active} 名有效 · {reserved} 名已邀请 · 容量：{capacity}"],
  accessReviewPending: ["A subscription change is awaiting confirmation in Modules.", "Hay un cambio de contratación pendiente de confirmar en Módulos.", "Une modification d’abonnement attend confirmation dans Modules.", "Há uma alteração de contratação aguardando confirmação em Módulos.", "모듈에서 구독 변경 확인이 필요합니다.", "模块中有一项订阅更改等待确认。"],
  workspacePaymentExtension: ["Payment deadline extended", "Plazo de pago ampliado", "Échéance de paiement prolongée", "Prazo de pagamento ampliado", "결제 기한 연장", "付款期限已延长"],
  workspaceLoading: ["Loading…", "Cargando…", "Chargement…", "Carregando…", "불러오는 중…", "正在加载…"],
  workspaceCompleted: ["Completed", "Completado", "Terminé", "Concluído", "완료", "已完成"],
  workspaceRootUsers: ["Users with platform Root", "Usuarios con Root de plataforma", "Utilisateurs Root de plateforme", "Usuários Root da plataforma", "플랫폼 Root 사용자", "平台 Root 用户"],
  workspaceSummary: ["Summary", "Resumen", "Résumé", "Resumo", "요약", "概览"],
  workspaceUsers: ["Users and roles", "Usuarios y roles", "Utilisateurs et rôles", "Usuários e funções", "사용자 및 역할", "用户与角色"],
  workspaceModules: ["Modules and courtesy access", "Módulos y cortesías", "Modules et accès offerts", "Módulos e cortesias", "모듈 및 무료 이용권", "模块与赠送权限"],
  workspaceBilling: ["Billing and collections", "Facturación y cobranza", "Facturation et recouvrement", "Faturamento e cobrança", "청구 및 수금", "账单与收款"],
  workspaceHistory: ["Customer history", "Historial del cliente", "Historique du client", "Histórico do cliente", "고객 이력", "客户历史"],
  workspaceHistoryHelp: ["Account, billing and sign-in events for this company.", "Cambios de cuenta, facturación e inicios de sesión de esta empresa.", "Événements de compte, facturation et connexion de cette entreprise.", "Eventos da conta, faturamento e acesso desta empresa.", "이 회사의 계정, 청구 및 로그인 이벤트입니다.", "此公司的账户、账单和登录事件。"],
  workspaceReload: ["Reload", "Volver a cargar", "Recharger", "Recarregar", "다시 불러오기", "重新加载"],
  workspaceLoadFailed: ["This section could not be loaded. Try again.", "No se pudo cargar esta sección. Vuelve a intentarlo.", "Impossible de charger cette section. Réessayez.", "Não foi possível carregar esta seção. Tente novamente.", "이 섹션을 불러오지 못했습니다. 다시 시도하세요.", "无法加载此部分，请重试。"],
  workspaceBilled: ["Amount due", "Importe a pagar", "Montant dû", "Valor devido", "청구 금액", "应付金额"],
  workspacePaidAmount: ["Amount paid", "Importe pagado", "Montant payé", "Valor pago", "결제 금액", "已付金额"],
  workspaceDownload: ["Download invoice", "Descargar factura", "Télécharger la facture", "Baixar fatura", "청구서 다운로드", "下载发票"],
  workspaceAccountType: ["Commercial relationship", "Relación comercial", "Relation commerciale", "Relação comercial", "상업적 관계", "商业关系"],
  workspaceClient: ["Client", "Cliente", "Client", "Cliente", "고객", "客户"],
  workspacePlatformAccess: ["Platform authority", "Autoridad de plataforma", "Droits de plateforme", "Autoridade da plataforma", "플랫폼 권한", "平台权限"],
  workspaceCompanyAccess: ["Company roles only", "Roles de empresa", "Rôles d’entreprise", "Funções da empresa", "회사 역할", "公司角色"],
  workspaceNoLimit: ["No seat limit enforced", "Sin límite de usuarios aplicado", "Aucune limite d’utilisateurs appliquée", "Sem limite de usuários aplicado", "사용자 수 제한 없음", "未实施用户数量限制"],
  workspacePriceEstimate: ["Estimated rate · no active paid contract", "Tarifa estimada · sin contrato de pago activo", "Tarif estimé · sans contrat payant actif", "Tarifa estimada · sem contrato pago ativo", "예상 요금 · 유효한 유료 계약 없음", "预估费用 · 无有效付费合同"],
  workspaceSupportEvent: ["Account administration", "Administración de cuenta", "Administration du compte", "Administração da conta", "계정 관리", "账户管理"],
  workspaceBillingEvent: ["Billing update", "Actualización de facturación", "Mise à jour de facturation", "Atualização de faturamento", "청구 업데이트", "账单更新"],
  workspaceLoginEvent: ["Account sign-in", "Acceso a la cuenta", "Connexion au compte", "Acesso à conta", "계정 로그인", "账户登录"],
  workspaceUnknownActor: ["System", "Sistema", "Système", "Sistema", "시스템", "系统"],
  workspaceNoHistory: ["No recorded events for this company.", "Esta empresa todavía no tiene eventos registrados.", "Aucun événement enregistré pour cette entreprise.", "Esta empresa ainda não tem eventos registrados.", "이 회사에 기록된 이벤트가 없습니다.", "此公司暂无记录事件。"],
  workspaceChangeRole: ["Change company role", "Cambiar rol en la empresa", "Modifier le rôle dans l’entreprise", "Alterar função na empresa", "회사 역할 변경", "更改公司角色"],
  workspaceRoleUpdated: ["The company role was updated.", "Se actualizó el rol en la empresa.", "Le rôle dans l’entreprise a été mis à jour.", "A função na empresa foi atualizada.", "회사 역할이 업데이트되었습니다.", "公司角色已更新。"],
  workspaceRoleFailed: ["The role could not be updated.", "No se pudo actualizar el rol.", "Impossible de modifier le rôle.", "Não foi possível atualizar a função.", "역할을 업데이트하지 못했습니다.", "无法更新角色。"],
  workspaceSavedRefreshFailed: ["Saved. The view could not be refreshed; reload it to see the changes.", "Guardado. No se pudo actualizar la vista; vuelve a cargarla para ver los cambios.", "Enregistré. Rechargez la vue pour voir les modifications.", "Salvo. Recarregue a visualização para ver as alterações.", "저장되었습니다. 변경 사항을 보려면 다시 불러오세요.", "已保存。请重新加载以查看更改。"],
  workspacePeriod: ["Billing period", "Periodo de facturación", "Période de facturation", "Período de faturamento", "청구 기간", "账单周期"],
  workspaceIdentityHelp: ["Company roles and platform authority are managed separately.", "Los roles dentro de la empresa y la autoridad de plataforma se administran por separado.", "Les rôles d’entreprise et les droits de plateforme sont gérés séparément.", "As funções da empresa e a autoridade da plataforma são gerenciadas separadamente.", "회사 역할과 플랫폼 권한은 별도로 관리됩니다.", "公司角色与平台权限分别管理。"],
  workspaceViewBilling: ["View billing", "Ver facturación", "Voir la facturation", "Ver faturamento", "청구 보기", "查看账单"],
  workspaceEffectiveAccess: ["Current access", "Acceso vigente", "Accès actuel", "Acesso vigente", "현재 이용 권한", "当前权限"],
  workspaceNextEvent: ["Next event", "Próximo evento", "Prochain événement", "Próximo evento", "다음 일정", "下一事件"],
  workspaceHistoryReason: ["Reason", "Motivo", "Motif", "Motivo", "사유", "原因"],
