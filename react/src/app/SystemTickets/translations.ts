...
const en: TicketCopy = {
  ...
  reportedBy: 'Reported by', updated: 'Last update', actions: 'Actions', view: 'View ticket', print: 'Print', noTickets: 'No tickets match these filters.',
  ...
  selectModule: 'Select a module', photoEvidence: 'Photo evidence', addPhoto: 'Add photo', changePhoto: 'Change photo', removePhoto: 'Remove photo',
  photoHelp: 'Optional. PNG, JPG or WEBP up to 10 MB.', photoTypeError: 'Select a PNG, JPG or WEBP image.', photoSizeError: 'The photo must be no larger than 10 MB.',
...
const es: TicketCopy = {
  ...
  reportedBy: 'Reportado por', updated: 'Última actualización', actions: 'Acciones', view: 'Ver ticket', print: 'Imprimir', noTickets: 'No hay tickets con estos filtros.',
  ...
  selectModule: 'Selecciona un módulo', photoEvidence: 'Evidencia fotográfica', addPhoto: 'Agregar foto', changePhoto: 'Cambiar foto', removePhoto: 'Quitar foto',
  photoHelp: 'Opcional. PNG, JPG o WEBP de hasta 10 MB.', photoTypeError: 'Selecciona una imagen PNG, JPG o WEBP.', photoSizeError: 'La foto no puede superar los 10 MB.',
...
const fr: TicketCopy = {
  ...
  create: 'Créer le billet', close: 'Fermer', save: 'Enregistrer', print: 'Imprimer', rootResponse: 'Réponse Root', itemLabel: 'billets',
};
...
const pt: TicketCopy = {
  ...
  create: 'Criar ticket', close: 'Fechar', save: 'Salvar', print: 'Imprimir', rootResponse: 'Resposta da Root', itemLabel: 'tickets',
};

const ko: TicketCopy = { ...en, tab: '시스템 티켓', title: '시스템 티켓', newTicket: '새 티켓', search: '검색', all: '전체', active: '열린 티켓', close: '닫기', save: '저장', print: '인쇄', itemLabel: '티켓' };
const zh: TicketCopy = { ...en, tab: '系统工单', title: '系统工单', newTicket: '新建工单', search: '搜索', all: '全部', active: '未结工单', close: '关闭', save: '保存', print: '打印', itemLabel: '工单' };
