...
prepare_backend_env() {
  ...
  grep -v -E '^(SERVER_PORT|SERVER_ADDRESS|JAVA_OPTS|APP_STORAGE_MINIO_ENDPOINT|APP_STORAGE_MINIO_PUBLIC_ENDPOINT|APP_STORAGE_MINIO_SERVICE_PUBLIC_ENDPOINT|APP_HR_FACE_SERVICE_BASE_URL|APP_WEB_ALLOWED_ORIGINS|APP_WEB_PUBLIC_URL|APP_WEB_INVITATION_BASE_URL|APP_WEB_PASSWORD_RESET_BASE_URL|APP_PRODUCT_ANALYTICS_WEB_INGEST_TOKEN|APP_BILLING_STRIPE_SECRET_KEY_FILE|APP_BILLING_STRIPE_WEBHOOK_SECRET_FILE)=' \
    "${ENV_FILE}" >"${output}"
